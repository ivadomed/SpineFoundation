...
def build_datasets(data_path,json_path,splits,shuffle_seed,rank=0,inference=False,only_validation=True,label=False):
    if rank==0:
        print("\nDATA :\n")
    ...
    shuffle_seed=shuffle_seed,data_path=data_path,json_path=json_path,rank=rank,label=label)
