...
def build_dataloaders(batch_size,splits=(0.8, 0.1, 0.1),num_workers=2,shuffle_seed=None,data_path=False,json_path=False,json_save=False):
    ...
    train_loader = DataLoader(train_ds, batch_size=batch_size, shuffle=True, num_workers=num_workers,pin_memory=True,persistent_workers=True,prefetch_factor=1,collate_fn=list_collate)
    val_loader = DataLoader(val_ds, batch_size=batch_size, shuffle=False, num_workers=num_workers,pin_memory=True,persistent_workers=True,prefetch_factor=1,collate_fn=list_collate)
